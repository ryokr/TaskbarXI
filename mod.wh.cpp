...
// @twitter         https://twitter.com/ryokr
// @homepage        https://ryokr.com/
...
// https://github.com/ryokr/my-windhawk-mods
...
[![RyoMeow](https://raw.githubusercontent.com/ramensoftware/windows-11-taskbar-styling-guide/main/Themes/RyoMeow/screenshot.png)
\
RyoMeow](https://github.com/ramensoftware/windows-11-taskbar-styling-guide/blob/main/Themes/RyoMeow/README.md)
...
SystemTrayResources.xbf](https://gist.github.com/ryokr/ad0ab39351aca905f1d186b1f1c3d8c7).
...
const Theme g_themeRosePine = {{
    ...
    ThemeTargetStyles{L"Taskbar.TaskListLabeledButtonPanel@CommonStates > Rectangle#RunningIndicator", {
        ...
        L"Fill=Transparent",
        L"Width=37%",
        L"VerticalAlignment=1"}},  // active border of app items
...
void ProcessAllStylesFromSettings() {
    ...
    } else if (wcscmp(themeName, L"RyoMeow") == 0) {
        theme = &g_themeRyoMeow;
